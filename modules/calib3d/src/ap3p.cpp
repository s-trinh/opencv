...
bool ap3p::solve(double R[3][3], double t[3],
...
int ap3p::solve_for_lengths(double lengths[4][3], double distances[3], double cosines[3])
{
...
bool ap3p::align(double M_end[3][3],
...
bool ap3p::jacobi_4x4(double * A, double * D, double * U)
{
    double B[4] = {}, Z[4] = {};
