...
void p3p_usac::calibrateAndNormalizePointsPnP(const Mat &opoints_, const Mat &ipoints_) {
...
int p3p_usac::estimate(std::vector<Mat>& Rs, std::vector<Mat>& ts, const cv::Mat &opoints, const cv::Mat &ipoints) {
   /*
...
std::array<Vec3d, 2> compute_pq(Matx33d C) {
...
void refine_lambda(double &lambda1, double &lambda2, double &lambda3, const double a12, const double a13,
